...
if [ -n "$OPENEDX_RELEASE" ]; then
  EXTRA_VARS="-e edx_platform_version=$OPENEDX_RELEASE \
	...
	-e EDXAPP_PLATFORM_NAME='Hneu EDX' \
	-e EDXAPP_DEFAULT_FROM_EMAIL='edx@hneu.net' \
	-e EDXAPP_LANGUAGE_CODE=ru \
	-e EDXAPP_EMAIL_HOST=smtp.gmail.com
	-e EDXAPP_EMAIL_PORT=587 \
	-e EDXAPP_EMAIL_USE_TLS=True \
	-e EDXAPP_EMAIL_HOST_USER=edx@hneu.net\
	-e EDXAPP_EMAIL_HOST_PASSWORD='12edx0-='\ 
  "
